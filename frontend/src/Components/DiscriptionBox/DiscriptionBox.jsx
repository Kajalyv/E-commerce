    ...
    <div className="descriptionbox">
      ...
      <div className="descriptionbox-description">
        <p>
          ...
          popularity due to their convenience accessibility, and global reach
          they offer.
        </p>
        <p>
            E-commerce websites typically display products or services along with detailde descriptions. images, prices, and any available variations (e.g. sizes, colors). Each product usually has its own dedicated page with relevant information.
        </p>
      </div>
    </div>
  );

...
mongoose.connect("mongodb+srv://greatstackdev:001001001@cluster0.pnvb7lr.mongodb.net/e-commerce")
...
const fetchUser = async (req,res,next)=>{
    ...
    if(!token){
        res.status(401).send({error:"please authendicate using valid token"});
    }
    else{
        try{
